# pocket-ui/src/main/res/drawable/ic_my_list_checkable.xml
## What this is
This file is the `ic_my_list_checkable` vector icon (a `vector` XML: resolution-independent line art Android rasterizes at any density, so one file serves all screens). It draws the list lines glyph used on buttons, rows, and toolbars across the app. 
## How it fits
