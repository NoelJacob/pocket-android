# pocket-ui/src/main/res/drawable/ic_pkt_theme_light.xml
## What this is
This file is the `ic_pkt_theme_light` vector icon (a `vector` XML: resolution-independent line art Android rasterizes at any density, so one file serves all screens). It draws the theme mode glyph used on buttons, rows, and toolbars across the app. 
## How it fits
...
- Size: `36dp x 36dp`.
- Viewport: `36 x 36`.
- Baked fill colors: `#FFFFFF` (usually overridden by tint).
