...
This is a Gradle convention plugin (`com.pocket.kotlin.jvm`): the shared build recipe applied with one line instead of repeating Android/Kotlin setup in every module. Convention plugins are how this repo keeps 10+ modules' builds consistent.
...
Build setup declared here: `java`, `kotlin`, `setDefaultConfigs`.
