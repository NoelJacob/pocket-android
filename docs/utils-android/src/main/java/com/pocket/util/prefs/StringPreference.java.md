# utils-android/src/main/java/com/pocket/util/prefs/StringPreference.java
...
- `StringPreference` (interface, line 3) — core type of this file; callers reference it by name.
- `get` (fun, line 5) — The current value. If {@link #set(String)} has never been called, it returns the default value. Use {@link #isSet()} if you need to known.
