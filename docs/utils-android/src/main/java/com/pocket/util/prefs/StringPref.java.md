# utils-android/src/main/java/com/pocket/util/prefs/StringPref.java
...
- `StringPref` (class, line 6) — Implementation of {@link StringPreference}
- `get` (fun, line 19) — entry point other code calls; see callers for context.
- `set` (fun, line 24) — entry point other code calls; see callers for context.
- `isSet` (fun, line 29) — entry point other code calls; see callers for context.
- `changes` (fun, line 34) — entry point other code calls; see callers for context.
- `getWithChanges` (fun, line 39) — entry point other code calls; see callers for context.
