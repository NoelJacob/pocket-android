# utils-android/src/main/java/com/pocket/util/prefs/EnumPreference.java
...
- `EnumPreference` (interface, line 3) — core type of this file; callers reference it by name.
- `get` (fun, line 5) — The current value. If {@link #set(E)} has never been called, it returns the default value. Use {@link #isSet()} if you need to known.
