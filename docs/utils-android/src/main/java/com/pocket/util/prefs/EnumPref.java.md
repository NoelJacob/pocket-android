# utils-android/src/main/java/com/pocket/util/prefs/EnumPref.java
...
- `EnumPref` (class, line 6) — Implementation of {@link EnumPreference}
- `get` (fun, line 21) — entry point other code calls; see callers for context.
- `from` (fun, line 25) — entry point other code calls; see callers for context.
- `set` (fun, line 30) — entry point other code calls; see callers for context.
- `isSet` (fun, line 35) — entry point other code calls; see callers for context.
- `changes` (fun, line 40) — entry point other code calls; see callers for context.
- `getWithChanges` (fun, line 45) — entry point other code calls; see callers for context.
