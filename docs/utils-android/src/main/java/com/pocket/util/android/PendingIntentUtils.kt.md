# utils-android/src/main/java/com/pocket/util/android/PendingIntentUtils.kt
...
- `PendingIntentUtils` (object, line 6) — core type of this file; callers reference it by name.
- `addMutableFlag` (fun, line 16) — entry point other code calls; see callers for context.
