...
Build setup declared here: `api`, `dependencies`, `dependsOn`, `getSyncPocketGenTaskOutputDir`, `implementation`, `java.srcDir`, `kotlin`, `kotlinJvm`, `main`, `registerSyncPocketGenTask`, `sourceSets`, `testImplementation`.
