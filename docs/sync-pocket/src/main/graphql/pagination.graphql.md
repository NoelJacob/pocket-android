# sync-pocket/src/main/graphql/pagination.graphql

## What this is

This is a GraphQL operations file for the sync layer: it declares the fields and shapes the app asks the server for. Apollo codegen reads it at build time and generates the typed request/response classes the sources use. Key entries include `pageInfoFields PageInfo`.
...
- `pageInfoFields PageInfo` — declared operation/type in this file; generated classes carry this name into ClientApiSource call sites.
