# sync-pocket/src/main/java/com/pocket/sdk/api/value/Timestamp.java
...
- `Timestamp` (class, line 8) — The convention for timestamps in Pocket. A unix timestamp in seconds.
- `millis` (fun, line 25) — entry point other code calls; see callers for context.
- `seconds` (fun, line 32) — entry point other code calls; see callers for context.
- `now` (fun, line 39) — entry point other code calls; see callers for context.
- `fromMillis` (fun, line 48) — Create a timestamp from a milliseconds timestamp
- `get` (fun, line 67) — entry point other code calls; see callers for context.
...
Names you will also see here: `Time`.
