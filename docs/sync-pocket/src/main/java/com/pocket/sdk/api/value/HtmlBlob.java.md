# sync-pocket/src/main/java/com/pocket/sdk/api/value/HtmlBlob.java
...
- `HtmlBlob` (class, line 8) — A String that contains html as a string. Could be fairly large depending on the size of the webpage.
- `equals` (fun, line 17) — entry point other code calls; see callers for context.
- `hashCode` (fun, line 25) — entry point other code calls; see callers for context.
- `toString` (fun, line 30) — entry point other code calls; see callers for context.
- `isBlank` (fun, line 34) — entry point other code calls; see callers for context.
- `toString` (fun, line 38) — entry point other code calls; see callers for context.
