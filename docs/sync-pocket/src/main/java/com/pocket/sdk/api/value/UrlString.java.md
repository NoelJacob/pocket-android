# sync-pocket/src/main/java/com/pocket/sdk/api/value/UrlString.java
...
- `UrlString` (class, line 8) — A http or https url string.
- `equals` (fun, line 19) — entry point other code calls; see callers for context.
- `hashCode` (fun, line 29) — entry point other code calls; see callers for context.
- `toString` (fun, line 34) — entry point other code calls; see callers for context.
- `asString` (fun, line 38) — entry point other code calls; see callers for context.
