# sync-pocket/src/main/java/com/pocket/sdk/api/value/EscapedString.java
...
- `EscapedString` (class, line 10) — The original escaped value is available as {@link #value}.
- `unescaped` (fun, line 24) — The unescaped string.
- `equals` (fun, line 32) — entry point other code calls; see callers for context.
- `hashCode` (fun, line 40) — entry point other code calls; see callers for context.
- `toString` (fun, line 45) — entry point other code calls; see callers for context.
- `isBlank` (fun, line 49) — entry point other code calls; see callers for context.
- `unescaped` (fun, line 53) — entry point other code calls; see callers for context.
