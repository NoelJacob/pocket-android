# sync-pocket/src/main/java/com/pocket/sdk/api/value/IsoDateString.kt
...
- `IsoDateString` (data class, line 6) — core type of this file; callers reference it by name.
- `toInstant` (fun, line 7) — entry point other code calls; see callers for context.
- `Instant` (fun, line 10) — entry point other code calls; see callers for context.
