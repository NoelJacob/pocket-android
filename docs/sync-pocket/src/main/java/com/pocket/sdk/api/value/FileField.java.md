# sync-pocket/src/main/java/com/pocket/sdk/api/value/FileField.java
...
- `FileField` (class, line 8) — core type of this file; callers reference it by name.
- `asFile` (fun, line 21) — entry point other code calls; see callers for context.
- `equals` (fun, line 26) — entry point other code calls; see callers for context.
