# sync-pocket/src/main/java/com/pocket/sdk/api/value/AccessToken.java
...
- `AccessToken` (class, line 10) — An id token that gives access to something and should be protected.
- `toString` (fun, line 35) — entry point other code calls; see callers for context.
