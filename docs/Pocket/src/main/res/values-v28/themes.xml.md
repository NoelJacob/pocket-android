# Pocket/src/main/res/values-v28/themes.xml

## What this is

This file defines 2 named styles/themes active for API v28: reusable bundles of colors, text appearances, and window flags so screens share one look.
